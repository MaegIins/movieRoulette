...
const MESSAGES = {
  fr: {
    ...
    'lang.fr': 'Français',
    'lang.en': 'Anglais',
    'settings.length': 'Durée',
    'settings.lengthDesc': 'Types de films inclus dans les suggestions.',
    'length.short': 'Court métrage',
    'length.long': 'Long métrage',
    'settings.strict': 'Résultats stricts',
    'settings.strictDesc':
      "N'élargit jamais les critères de recherche : affiche moins de films (voire aucun) plutôt que d'assouplir les filtres.",
  ...
  en: {
    ...
    'settings.lengthDesc': 'Movie types included in the suggestions.',
    'length.short': 'Short film',
    'length.long': 'Feature film',
    'settings.strict': 'Strict results',
    'settings.strictDesc': 'Never broadens the search criteria: shows fewer movies (or none) rather than relaxing filters.',
